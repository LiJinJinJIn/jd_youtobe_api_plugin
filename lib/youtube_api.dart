...
import 'package:jd_youtobe_api_plugin/_api.dart';
...
class YoutubeAPI {
  ...
  Future<List<YT_API>> getTrends({@required String regionCode, String videoCategoryId = ""}) async {
    this.regionCode = regionCode;
    this.getTrending = true;
    Uri url = api.trendingUri(regionCode: this.regionCode, videoCategoryId: videoCategoryId);
